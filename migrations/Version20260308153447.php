 ...
 */
final class Version20260308153447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dossier (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, user_id INT NOT NULL, vehicule_id INT NOT NULL, INDEX IDX_3D48E037A76ED395 (user_id), INDEX IDX_3D48E0374A4A3511 (vehicule_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
